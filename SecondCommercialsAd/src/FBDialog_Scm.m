...
- (id)init {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        // Add By Young
        NSString *filePathX = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDirectory, YES) objectAtIndex:0] stringByAppendingPathComponent:@"xmark.png"];
        UIImage *imageX = [UIImage imageWithData:[NSData dataWithContentsOfFile:filePathX]];
        [_closeButton setImage:imageX forState:UIControlStateNormal];
        _closeButton.opaque = YES;
...
- (void)show {
    ...
    _modalBackgroundView.frame = CGRectMake(20, 20, window.frame.origin.x-40, window.frame.origin.y-40);
