...
@interface FBDialog_Scm : UIView <UIWebViewDelegate> {
  id<FBDialogDelegate_Scm> _delegate;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<FBDialogDelegate_Scm> delegate;
...
- (id)initWithURL: (NSString *) loadingURL
         ...
         delegate: (id <FBDialogDelegate_Scm>) delegate;
 ...
 */
@protocol FBDialogDelegate_Scm <NSObject>
 ...
 */
- (void)dialogDidComplete:(FBDialog_Scm *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(FBDialog_Scm *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(FBDialog_Scm*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(FBDialog_Scm*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
